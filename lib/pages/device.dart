      ...
      children: [
        Row(
          children: [
            ...
            Text(
              deviceConnected.isConnected ? 'Conectado' : 'Desconectado',
                            ...
                            color: resultTest == AlcoholTestResult.seguro
                                ...
                                : (resultTest == AlcoholTestResult.alerta
                                    ...
                                    : (resultTest == AlcoholTestResult.perigoso
                                        ? AppColors.red
                                        : AppColors.grayDark)),
                            value: (deviceConnected.currentTest?.value ?? 0.03) *
                                10)),
                    Center(
            ...
            children: [
              ...
              Expanded(
                  child: ListView.separated(
                      itemBuilder: (context, index) => HistoryItem(alcoholTest: deviceConnected.history[index],),
